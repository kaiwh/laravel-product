			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="page-header">
						<h1>@Lang('admin::productCategory.heading.create')</h1>
						<ul class="breadcrumb">
							...
							<li><a href="{{ route('admin.product.category.create') }}">@Lang('admin::productCategory.heading.create')</a></li>
						</ul>
				...
				<div class="panel-body">
					...
					@endif
					<form method="POST" action="{{ route('admin.product.category.create') }}" class="form-horizontal" id="form">
	            		{{ csrf_field() }}
